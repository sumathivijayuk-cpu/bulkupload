...
//test.describe.serial('runs the tastcase in serial mode',async()=>{
test.describe.parallel("runs the tastcase in parallel mode",async()=>{

    test.beforeAll('data Connectivity',async()=>{                                   // check data connection before all the test
